...
<Table>
  <tbody>
    <Table.Tr>
      ...
      <Table.Td>Controle de structure</Table.Td>
</Table.Tr>
<Table.Tr>
      <Table.Td>Titre</Table.Td>
      <Table.Td>Boucle</Table.Td>
</Table.Tr>
<Table.Tr>
      <Table.Td>Description</Table.Td>
      <Table.Td>La boucle est une action permettant d'exécuter un prompt sur une liste d'éléments. Elle est principalement utilisée pour traiter des documents de grande taille et se place après une découpe pour traiter chaque élément résultant de la découpe.</Table.Td>
</Table.Tr>
</tbody>
</Table>
