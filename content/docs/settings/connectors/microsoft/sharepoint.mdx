...
Choisissez la visibilité en fonction de qui peut utiliser cette clé admin pour donner les droits à `JaskSSO`. Nous vous conseillons de la partager qu'aux administrateurs connectant les sites SharePoint. Cliquez sur `Valider`.
